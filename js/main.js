...
function lisaaMarker(crd, latauspiste = '', kuvake, teksti = 'Olen tässä.',
  ...
  L.marker([crd.latitude, crd.longitude], kuvake).
      addTo(map).
      bindPopup(
          '<b>' + teksti + '</b><br> <span class="osoite">' + osoite + ', ' +
          kaupunki + '</span><br>' +
          '<span class=\'pienempiteksti\'>' + kordinaattix + ', ' +
          kordinaattiy +
          '</span><br><br>' + '<b>Hinta:</b> ' + usagecost + '<br>' +
          '<b>Tyyppi:</b> ' + tyyppi +
          '<br><b>Käyttö:</b> ' + connectiontype + '<br>' + '<b>AC/DC:</b> ' +
          acdc + '<br><br>' + käyttö + '<br><br> Määrä:' + pistokkeet + '<br>' +
...
function haeLatauspisteet(crd) {
  ...
  fetch(
      `https://api.openchargemap.io/v3/poi/?distanceunit=KM&distance=${rangeslider.value}&latitude=${crd.latitude}&longitude=${crd.longitude}&maxresults=250`).
